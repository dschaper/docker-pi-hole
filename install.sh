...
curl -sL https://api.github.com/repos/dschaper/pi-hole/tarball/fix/touch_guard | tar -xz --strip-components 1 -C /etc/.pihole
bash -ex automated\ install/basic-install.sh --unattended
